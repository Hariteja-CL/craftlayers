            ...
            <div className="absolute bottom-0 left-0 right-0 h-20 bg-white border-t border-neutral-200 px-2 flex items-center justify-around">
              {navItems.map((item) => {
                ...
                return (
                  ...
                  >
                    <Icon
                      className={`size-5 transition-colors ${isActive ? 'text-orange-500' : 'text-neutral-400'
                        }`}
                    />
                    <span
                      className={`text-xs transition-colors ${isActive ? 'text-orange-500' : 'text-neutral-500'
                        }`}
                    >
                      {item.label}
                    </span>
