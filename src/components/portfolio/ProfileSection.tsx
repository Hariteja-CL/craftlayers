        ...
        <div className="w-full h-full bg-[#EBF2FA] rounded-[2rem] p-8 md:p-12 flex flex-col md:flex-row items-center gap-8 md:gap-12 relative overflow-hidden group hover:shadow-lg transition-all duration-300">
            ...
            <div className="relative z-10 flex-shrink-0">
                <div className="w-32 h-32 md:w-40 md:h-40 rounded-full border-4 border-white shadow-xl overflow-hidden relative">
                    <img src="/assets/images/profile-hero.svg" alt="Hariteja" className="w-full h-full object-cover" />
                    <div className="absolute bottom-2 right-2 bg-white rounded-full p-1 shadow-sm">
                        <img src="/assets/images/linkedin.svg" alt="in" className="w-4 h-4" />
                    </div>
                </div>
            </div>
            ...
            <div className="relative z-10 flex-1 text-center md:text-left space-y-4">
                <div>
                    <div className="flex items-center justify-center md:justify-start gap-2 text-gray-400 text-xs uppercase tracking-wide font-semibold mb-2">
                ...
                <div className="flex items-center justify-center md:justify-start gap-4 pt-2">
                    <a href="https://linkedin.com/in/hariteja-nandipati" className="bg-[#1A1A1A] text-white px-6 py-2.5 rounded-full text-sm font-medium hover:bg-black flex items-center gap-2">
                        <span className="text-lg">in</span> Connect
                    </a>
                    <a href="#" className="bg-white border border-gray-200 text-gray-700 px-6 py-2.5 rounded-full text-sm font-medium hover:bg-gray-50">
                        Download Resume
                    </a>
                </div>
            </div>
